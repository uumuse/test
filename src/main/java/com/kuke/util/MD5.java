 ...
 * File Name:MD5.java 
 * Create Time:2012-4-6 上午11:56:43
 ...
 *@version: Revision:2.0.0, 2012-4-6 上午11:56:43
 */
public class MD5 {
	...
	public static void main(String args[]) {
		...
		if (args.length == 0) {
			...
			System.out.println("MD5(\"1234\"):" + m.getMD5ofStr("9500").length());
	...
	public static String encodeByMD5(String string){
		MD5 md5 = new MD5();
		String str = md5.getMD5ofStr(string);
		return str;
	}
